// Dafny program BasicGenerate.dfy compiled into C#
...
module TestComAmazonawsKms {
  ...
  method {:test} BasicGenerate()
  {
    ...
    var client :- Kms.KMSClient();
    var keyLength := 32;
    var request := Kms.Types.GenerateDataKeyRequest(KeyId := keyId, EncryptionContext := Kms.Wrappers.None, NumberOfBytes := Kms.Wrappers.Some(keyLength as Kms.Types.NumberOfBytesType), KeySpec := Kms.Wrappers.None, GrantTokens := Kms.Wrappers.None);
    ...
    expect |Plaintext.value| == keyLength, ""expectation violation""
  }
}
...
namespace TestComAmazonawsKms_Compile {
  ...
  public partial class __default {
    public static void BasicGenerate()
    {
      ...
      if (!((_83_Plaintext).is_Some)) {
        throw new Dafny.HaltException("/Users/ryanemer/aws-encryption-sdk-dafny/src/AWS-KMS/test/BasicGenerate.dfy(30,4): " + Dafny.Sequence<char>.FromString("expectation violation"));
      }
      if (!((new BigInteger(((_83_Plaintext).dtor_value).Count)) == (_79_keyLength))) {
        throw new Dafny.HaltException("/Users/ryanemer/aws-encryption-sdk-dafny/src/AWS-KMS/test/BasicGenerate.dfy(31,4): " + Dafny.Sequence<char>.FromString("expectation violation"));
      }
    }
  }
...
namespace _module {
  ...
  public partial class __default {
    public static void _Main()
    {
      bool _85_success;
      _85_success = true;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString(@"TestComAmazonawsKms.BasicGenerate: "));
      try {
        {
          TestComAmazonawsKms_Compile.__default.BasicGenerate();
          {
...
"));
        ...
        var _86_haltMessage = Dafny.Sequence<char>.FromString(e.Message);
        {
          Dafny.Helpers.Print(Dafny.Sequence<char>.FromString(@"FAILED
	"));
          Dafny.Helpers.Print(_86_haltMessage);
